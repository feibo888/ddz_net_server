...
PROTOBUF_NAMESPACE_OPEN
template<> ::fb::Person* Arena::CreateMaybeMessage<::fb::Person>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace fb {
...
class Person final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:fb.Person) */ {
 public:
  ...
  public:
  void clear_addr();
  const ::ffb::Address& addr() const;
  PROTOBUF_NODISCARD ::ffb::Address* release_addr();
  ::ffb::Address* mutable_addr();
  void set_allocated_addr(::ffb::Address* addr);
  private:
  const ::ffb::Address& _internal_addr() const;
  ::ffb::Address* _internal_mutable_addr();
  public:
  void unsafe_arena_set_allocated_addr(
      ::ffb::Address* addr);
  ::ffb::Address* unsafe_arena_release_addr();
  ...
  // .fb.Color color = 6;
  void clear_color();
  ::fb::Color color() const;
  void set_color(::fb::Color value);
  private:
  ::fb::Color _internal_color() const;
  void _internal_set_color(::fb::Color value);
  public:

  // @@protoc_insertion_point(class_scope:fb.Person)
 private:
  class _Internal;
...
inline int32_t Person::id() const {
  // @@protoc_insertion_point(field_get:fb.Person.id)
  return _internal_id();
}
...
inline void Person::set_id(int32_t value) {
  ...
  // @@protoc_insertion_point(field_set:fb.Person.id)
}
...
inline std::string* Person::add_name() {
  ...
  // @@protoc_insertion_point(field_add_mutable:fb.Person.name)
  return _s;
}
...
inline const std::string& Person::name(int index) const {
  // @@protoc_insertion_point(field_get:fb.Person.name)
  return _internal_name(index);
}
inline std::string* Person::mutable_name(int index) {
  // @@protoc_insertion_point(field_mutable:fb.Person.name)
...
inline void Person::set_name(int index, const std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:fb.Person.name)
}
...
inline void Person::set_name(int index, const char* value) {
  ...
  _impl_.name_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:fb.Person.name)
}
inline void Person::set_name(int index, const void* value, size_t size) {
  _impl_.name_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:fb.Person.name)
}
...
inline void Person::add_name(const std::string& value) {
  ...
  // @@protoc_insertion_point(field_add:fb.Person.name)
}
...
inline void Person::add_name(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _impl_.name_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:fb.Person.name)
}
inline void Person::add_name(const void* value, size_t size) {
  _impl_.name_.Add()->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_add_pointer:fb.Person.name)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>&
Person::name() const {
  // @@protoc_insertion_point(field_list:fb.Person.name)
  return _impl_.name_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>*
Person::mutable_name() {
  // @@protoc_insertion_point(field_mutable_list:fb.Person.name)
  return &_impl_.name_;
}
...
inline const std::string& Person::sex() const {
  // @@protoc_insertion_point(field_get:fb.Person.sex)
...
void Person::set_sex(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.sex_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:fb.Person.sex)
}
inline std::string* Person::mutable_sex() {
  std::string* _s = _internal_mutable_sex();
  // @@protoc_insertion_point(field_mutable:fb.Person.sex)
  return _s;
}
...
inline std::string* Person::release_sex() {
  // @@protoc_insertion_point(field_release:fb.Person.sex)
...
inline void Person::set_allocated_sex(std::string* sex) {
  ...
  // @@protoc_insertion_point(field_set_allocated:fb.Person.sex)
}
...
inline int32_t Person::age() const {
  // @@protoc_insertion_point(field_get:fb.Person.age)
...
inline void Person::set_age(int32_t value) {
  ...
  // @@protoc_insertion_point(field_set:fb.Person.age)
}
...
inline const ::ffb::Address& Person::_internal_addr() const {
  const ::ffb::Address* p = _impl_.addr_;
  return p != nullptr ? *p : reinterpret_cast<const ::ffb::Address&>(
      ::ffb::_Address_default_instance_);
}
inline const ::ffb::Address& Person::addr() const {
  // @@protoc_insertion_point(field_get:fb.Person.addr)
...
inline void Person::unsafe_arena_set_allocated_addr(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:fb.Person.addr)
}
inline ::ffb::Address* Person::release_addr() {
  
  ::ffb::Address* temp = _impl_.addr_;
...
inline ::ffb::Address* Person::unsafe_arena_release_addr() {
  // @@protoc_insertion_point(field_release:fb.Person.addr)
  
  ::ffb::Address* temp = _impl_.addr_;
  _impl_.addr_ = nullptr;
  return temp;
}
inline ::ffb::Address* Person::_internal_mutable_addr() {
  
  if (_impl_.addr_ == nullptr) {
    auto* p = CreateMaybeMessage<::ffb::Address>(GetArenaForAllocation());
    _impl_.addr_ = p;
  }
  return _impl_.addr_;
}
inline ::ffb::Address* Person::mutable_addr() {
  ::ffb::Address* _msg = _internal_mutable_addr();
  // @@protoc_insertion_point(field_mutable:fb.Person.addr)
  return _msg;
}
inline void Person::set_allocated_addr(::ffb::Address* addr) {
  ...
  _impl_.addr_ = addr;
  // @@protoc_insertion_point(field_set_allocated:fb.Person.addr)
}
...
inline ::fb::Color Person::_internal_color() const {
  return static_cast< ::fb::Color >(_impl_.color_);
}
inline ::fb::Color Person::color() const {
  // @@protoc_insertion_point(field_get:fb.Person.color)
  return _internal_color();
}
inline void Person::_internal_set_color(::fb::Color value) {
  
  _impl_.color_ = value;
}
inline void Person::set_color(::fb::Color value) {
  _internal_set_color(value);
  // @@protoc_insertion_point(field_set:fb.Person.color)
}
...
template <> struct is_proto_enum< ::fb::Color> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::fb::Color>() {
  return ::fb::Color_descriptor();
}
