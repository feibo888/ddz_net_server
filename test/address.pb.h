...
PROTOBUF_NAMESPACE_OPEN
template<> ::ffb::Address* Arena::CreateMaybeMessage<::ffb::Address>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace ffb {
...
class Address final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:ffb.Address) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:ffb.Address)
 private:
  class _Internal;
...
inline int32_t Address::num() const {
  // @@protoc_insertion_point(field_get:ffb.Address.num)
...
inline void Address::set_num(int32_t value) {
  ...
  // @@protoc_insertion_point(field_set:ffb.Address.num)
}
...
inline const std::string& Address::addr() const {
  // @@protoc_insertion_point(field_get:ffb.Address.addr)
...
void Address::set_addr(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.addr_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:ffb.Address.addr)
}
inline std::string* Address::mutable_addr() {
  std::string* _s = _internal_mutable_addr();
  // @@protoc_insertion_point(field_mutable:ffb.Address.addr)
  return _s;
}
...
inline std::string* Address::release_addr() {
  // @@protoc_insertion_point(field_release:ffb.Address.addr)
...
inline void Address::set_allocated_addr(std::string* addr) {
  ...
  // @@protoc_insertion_point(field_set_allocated:ffb.Address.addr)
}
